...
public:
    ...
    void initialize_cylinder(SimulationCore *sim, double radius, double height, double density, bool fixed, Vec3 initial_pos,
                             float friction = 0.5f, float restitution = 0.2f);
    void initialize_sphere(SimulationCore *sim, double radius, double density, bool fixed, Vec3 initial_pos,
                           float friction = 0.5f, float restitution = 0.2f);
